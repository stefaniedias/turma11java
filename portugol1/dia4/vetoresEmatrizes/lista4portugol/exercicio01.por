 ...
 * /
		...
		para (inteiro x = 0; x <LIMITE; x ++) 
		{
			...
			// Aqui nesse "se" a cada valor inserido no valor eu comparo com a variável maiorNumero, se por acaso ou número para maior é só eu colocar esse valor variável como sendo esse o novo maiorNumero
