 ...
 * /
...

	{
		...
		para (inteiro x = 0; x <LIMITE; x ++) 
		{
			...
			// Nesse "se" eu comparo cada número com o que tem dentro da variável maiorNumero, sempre que o número inserido nenhum vetor para maior do que aquele que está guardado na variável maiorNúmero, ele será alterado na variável maiorNúmero 
			...
			escrever ("O lançamento:", (x + 1), "foi", valoresDado [x])
			pula ()
		}
